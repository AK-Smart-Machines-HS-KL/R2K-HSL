# Phase F Probe Report (2026-08-07 21:55)
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| F0 | 92% | 100% | 89.1 | 1.00 | 0.97 | 0.00 | 0.00 | 0.00 | 1.02 | 0% | 289ms |

## Worst situations per config (hard-fail rate)

- **F0:** 2vs2_default (100%), 2vs2_goalie_pass (100%), emp_empirical-proven_restart_006 (100%), 3vs3_default (60%), 3vs3_overload (30%)
