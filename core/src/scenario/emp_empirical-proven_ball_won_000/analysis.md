# emp_empirical-proven_ball_won_000

![field diagram](field_diagram.png)

## Source
- Original match: 3vs3_attack_center_strat_aggro_20260730_035552
- Umschalt type: ball_won — Blue won possession
- Tag: empirical-proven (blue scored)
- Cluster: 12 similar fragments reduced to this representative

## Scope
Blue won a ball_won deep in the opponent half — test whether Blue capitalizes on the turnover and scores.

## Expert (Analysis)
Ball at (3.7, -0.0), deep in the opponent half. Closest blue: blue_2 (0.4m). Closest red: red_1 (0.4m). Possession: BLUE. Umschalt type: ball_won. Blue scored — this was a successful transition.
...
- Score delta: -7.48 (negative = bad for blue)
