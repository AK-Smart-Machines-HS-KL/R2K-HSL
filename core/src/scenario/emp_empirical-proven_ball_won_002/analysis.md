# emp_empirical-proven_ball_won_002

![field diagram](field_diagram.png)

## Source
- Original match: 3vs3_attack_center_strat_aggro_20260728_155002
...
## Expert (Analysis)
Ball at (3.9, 0.0), deep in the opponent half. Closest blue: blue_2 (0.4m). Closest red: red_2 (0.4m). Possession: BLUE. Umschalt type: ball_won. Blue scored — this was a successful transition.
...
- Score delta: -7.79 (negative = bad for blue)
