# emp_empirical-proven_restart_007

![field diagram](field_diagram.png)

## Source
- Original match: 3vs3_attack_center_strat_aggro_20260729_114723
...
## Expert (Analysis)
Ball at (3.5, -0.2), deep in the opponent half. Closest blue: blue_2 (0.4m). Closest red: red_2 (0.5m). Possession: BLUE. Umschalt type: restart. Blue scored — this was a successful transition.
...
blue_1 cover the goal line at (-4.0, -0.2)
```
...
- Score delta: -7.31 (negative = bad for blue)
