# emp_regression-anti_ball_won_009

![field diagram](field_diagram.png)

## Source
- Original match: 3vs3_attack_center_strat_aggro_20260729_120936
...
## Expert (Analysis)
Ball at (-4.1, -0.0), deep in Blue's own half, near Blue's goal. Closest blue: blue_1 (0.5m). Closest red: red_2 (0.4m). Possession: RED. Umschalt type: ball_won. Red scored — this was a defensive failure for Blue.
...
- Score delta: +8.17 (positive = good for blue)
