# emp_regression-anti_ball_won_011

![field diagram](field_diagram.png)

## Source
- Original match: 3vs3_attack_center_strat_aggro_20260730_034522
- Umschalt type: ball_won — Red won possession
- Tag: regression-anti (red scored)
- Cluster: 4 similar fragments reduced to this representative

## Scope
Red won a ball_won deep in Blue's half — test whether Blue can recover defensively and prevent the concession.

## Expert (Analysis)
Ball at (-4.5, -0.2), deep in Blue's own half, near Blue's goal. Closest blue: blue_1 (0.7m). Closest red: red_1 (0.3m). Possession: RED. Umschalt type: ball_won. Red scored — this was a defensive failure for Blue.
...
- Score delta: +8.72 (positive = good for blue)
