# emp_regression-anti_ball_won_012

![field diagram](field_diagram.png)

## Source
- Original match: 3vs3_attack_center_strat_aggro_20260729_223853
- Umschalt type: ball_won — Red won possession
- Tag: regression-anti (red scored)
- Cluster: 6 similar fragments reduced to this representative

## Scope
Red won a ball_won deep in Blue's half — test whether Blue can recover defensively and prevent the concession.

## Expert (Analysis)
Ball at (-3.9, 0.4), deep in Blue's own half, near Blue's goal. Closest blue: blue_1 (0.5m). Closest red: red_3 (0.3m). Possession: RED. Umschalt type: ball_won. Red scored — this was a defensive failure for Blue.
...
```
blue_1 kick
blue_3 move to (-3.4, -0.4)
blue_2 cover the goal line at (-4.0, 0.4)
```
...
- Score delta: +7.85 (positive = good for blue)
